...
from .views import projects_list, project_detail, create_newproject, project_dashboard, project_articles, project_hologram, galaxy_setting, deliver_D3, galaxy_telescope
